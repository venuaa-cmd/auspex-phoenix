...
const AssetTypeSelector = ({ isOpen, onClose, onSelect }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/90 backdrop-blur-sm p-4 animate-[fadeIn_0.2s_ease]">
            <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden">
                
                {/* HEADER */}
                <div className="bg-slate-50 p-6 border-b border-slate-200 flex justify-between items-center">
                    <div>
                        <h2 className="text-xl font-black text-slate-800 uppercase tracking-tight">Select Asset Class</h2>
                        <p className="text-slate-500 text-xs font-bold mt-1">Classify this new asset to enable specific tracking logic.</p>
                    </div>
